...
export const getAllReviews = (id) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get(backendUrl + `/api/v1/reviews?id=${id}`, config);
...
export const getAdminProduct = () => async (dispatch) => {
    try {
      ...
      const config = { withCredentials: true };
      const { data } = await axios.get(backendUrl + "/api/v1/admin/products", config);
...
export const updateProduct = (id, productData) => async (dispatch) => {
  ...
  export const deleteProduct = (id) => async (dispatch) => {
    try {
      ...
      const config = { withCredentials: true };
      const { data } = await axios.delete(backendUrl + `/api/v1/admin/product/${id}`, config);
