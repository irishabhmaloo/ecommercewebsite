...
export const loadUser = () => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get(backendUrl + `/api/v1/me`, config);
...
export const getAllUsers = () => async (dispatch) => {
    try {
      ...
      const config = { withCredentials: true };
      const { data } = await axios.get(backendUrl + `/api/v1/admin/users`, config);
  ...
  export const getUserDetails = (id) => async (dispatch) => {
    try {
      ...
      const config = { withCredentials: true };
      const { data } = await axios.get(backendUrl + `/api/v1/admin/user/${id}`, config);
  ...
  export const deleteUser = (id) => async (dispatch) => {
    try {
      ...
      const config = { withCredentials: true };
      const { data } = await axios.delete(backendUrl + `/api/v1/admin/user/${id}`, config);
